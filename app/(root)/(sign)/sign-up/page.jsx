  ...
  return (
    <div className={Sign.container_sign}>
      ...
      <div className={SignUpStyle.form}>
        {/* Номер пользователя для регистраций */}
        <div className={SignUpStyle.numberUser}>
          <p>Номер</p>
          <input
            type="text"
            placeholder="+996"
          ...
          />
          {errors.number && (
            <p className={SignUpStyle.error_message}>{errors.number}</p>
          )}
        </div>
        {/* тут должен быть селектор для выбора города, хз от куда он должен приходить */}
        <div className={SignUpStyle.passwordUser}>
          <p>Пароль</p>
          <input
            type="password"
        ...
        {/* Имя пользователя для регистраций и сохранение данных */}
        <div className={SignUpStyle.passwordUser}>
          <p>Пароль</p>
          <input
            type="password"
        ...
        {/* Фамилия пользователя для регистраций и сохранение данных */}
        <div className={SignUpStyle.passwordUser}>
          <p>Пароль</p>
          <input
            type="password"
        ...
        {/* Пароль для регистраций будет отправлять в бекенд */}
        <div className={SignUpStyle.passwordUser}>
          <p>Пароль</p>
          <input
            type="password"
